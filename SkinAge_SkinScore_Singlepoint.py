...
def skin_age_score_calculation(age_data, input_data, Sorted_Cluster_centroids, age_Sorted_Cluster_centroids):
    skin_age = []
    skin_age_hyd = []
    skin_age_sh = []
    skin_score = []
...
if __name__ == '__main__':
    file_path = 'All_data/'
    age = readcsv(file_path+'file.csv', 'Age')
    hydration = readcsv(file_path+'file.csv', 'Hydration')
    skinhealth = readcsv(file_path+'file.csv', 'Skinhealth')
    ...
    skin_age_pred, skin_score_pred = skin_age_score_calculation(age, x_data, x_data_k_centroids, age_Sorted_Cluster_centroids[0])
